...
\begin{frame}{Įrankių ekosistema}
    \begin{itemize}
        \item \textbf{Zig} -- sisteminė programavimo kalba, naudota emuliatoriaus implementacijai.
        \begin{itemize}
            \item \textit{comptime} -- kodo vykdymas kompiliavimo metu;
        ...
        \end{itemize}
        \pause
        \item \textbf{Nix} -- deklaratyvi paketų valdymo sistema.
        \begin{itemize}
...
\begin{frame}{Linux aplinka}
    \begin{itemize}
        ...
        \item Vartotojo erdvėje pateikiama BusyBox, Lua, TCC su musl C biblioteka.
...
\begin{frame}{Instrukcijų talpykla}
    ...
    \begin{columns}[T]
        ...
        \begin{figure}[h]
            \centering
            \input{tyrimas-icache/array-smaller.pgf}
