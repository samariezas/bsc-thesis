...
Linux paleidimo konfigūracijoje naudojamas adresų žemėlapis, matomas \ref{tab:emuliatoriaus-adresu-zemelapis} lentelėje.

\begin{table}[h]
    \centering
    \label{tab:emuliatoriaus-adresu-zemelapis}
    \begin{tabular}{|l|l|l|}
        \hline
