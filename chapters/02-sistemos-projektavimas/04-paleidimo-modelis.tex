...
\item \textbf{BusyBox} -- standartinių UNIX programų rinkinys (pvz. \texttt{ls}, \texttt{sh}, \texttt{tar} ir pan.);
\item \textbf{Lua} -- bendrosios paskirties programavimo kalba;
\item \textbf{/init} -- scenarijus, prijungiantis virtualias failų sistemas (\texttt{/proc}, \texttt{/dev} ir \texttt{/dev} ir paleidžiantis komandinę eilutę \texttt{sh} UART įrenginyje.
\end{itemize}
