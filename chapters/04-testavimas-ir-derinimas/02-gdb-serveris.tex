...
Papildomos monitor komandos realizuotos per \texttt{qRcmd}. \texttt{mempages} komanda skaito aktyvią puslapių lentelę arba nurodytą PPN, o \texttt{translate} leidžia patikrinti vieno virtualaus adreso vertimą. Šios komandos buvo ypač naudingos derinant Linux \texttt{satp} įjungimą, vartotojo erdvės puslapių lenteles ir \textit{page fault} priežastis.
