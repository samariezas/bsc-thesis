...
Kadangi emuliatorius paleidžia pilną Linux aplinką, klaidų paieška vien pagal terminalo išvestį būtų nepakankama. Dėl to projektuotas nuotolinio derinimo mechanizmas, suderinamas su GDB Remote Serial Protocol \cite{gdb_remote_protocol}. Derinimo serveris veikia per UNIX lizdą, o procesoriaus vykdymo ciklas kiekvieno žingsnio pradžioje patikrina, ar GDB serveris leidžia tęsti vykdymą.
