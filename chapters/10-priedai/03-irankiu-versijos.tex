...
Žemiau pateikiami du sąrašai darbe naudojamų įrankių. \ref{tbl:irankiai-nix} lentelėje pateikti įrankiai buvo gauti iš \texttt{nixpkgs} \textit{commit} \texttt{4b1164c3215f018c4442463a27689d973cffd750}, o \ref{tbl:irankiai-kompiliuoti} lentelės įrankiai kompiliuoti Nix pagalba iš išeities kodo.
...
\begin{table}[h]
    ...
    \hline
    \end{tabularx}
    \caption{Įrankiai, naudoti iš Nix paketų tvarkyklės. Šie įrankiai nebuvo kompiliuojami, jų paketai buvo gauti iš nixpkgs binary cache.}
...
\begin{table}[h]
    ...
    \hline
    Spike & \textit{commit} \texttt{3e58f5e} &
    ...
    \hline
    tcc & \textit{commit} \texttt{601a088} &
