...
\begin{itemize}
    \item \textbf{OpenSBI} -- žemo lygio programinė įranga, vykdoma \textit{Machine} privilegijų režime. Ji inicializuoja procesoriaus būseną, pateikia \textit{Supervisor Binary Interface} (SBI) sąsają operacinei sistemai ir perduoda valdymą Linux branduoliui. OpenSBI veikia kaip tarpinis sluoksnis tarp aparatinės įrangos ir Linux branduolio.
...
Net minimaliai sistemai reikalingas ne tik CPU modelis, bet ir UART, laikmatis, pertraukčių valdiklis bei atminties sritys firmware ir branduoliui. Ši priklausomybių grandinė paaiškina, kodėl darbe reikalinga atkuriama surinkimo aplinka: pasikeitus vienam sluoksniui, dažnai tenka perrinkti arba suderinti ir kitus sluoksnius.
