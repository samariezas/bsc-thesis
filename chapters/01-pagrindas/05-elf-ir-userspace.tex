...
Vartotojo erdvės programos emuliatoriuje pasiekia sistemą per dvejetainį programos formatą ir ABI. RISC-V psABI specifikacija apibrėžia kvietimo konvenciją, ELF objektų formatą, DWARF derinimo informaciją, kodo modelius, relokacijas ir susiejimo optimizacijas \cite{riscv_psabi}. Tai svarbu tiek vykdant atskirus testinius ELF failus, tiek paleidžiant programas Linux aplinkoje.
