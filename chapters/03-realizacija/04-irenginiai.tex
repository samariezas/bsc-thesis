...
RAM įrenginys realizuotas kaip baitų masyvas šeimininko sistemos atmintyje. Įkeliant OpenSBI, Linux, DTB ir initramfs, failų turinys įrašomas tiesiai į atitinkamas RAM sritis. Pradinė RAM reikšmė užpildoma \texttt{0xa1}, kad klaidingos neinicijuotos atminties prieigos būtų lengviau pastebimos derinimo metu.
...
PLIC ir CLINT įrenginiai patys nevykdo svečio kodo, bet jų būsena kiekvieno procesoriaus žingsnio pradžioje paverčiama CSR pertraukimų bitais. CLINT generuoja laikmačio pertraukimo būseną pagal \texttt{mtime} ir \texttt{mtimecmp}. PLIC tikrina UART šaltinį, jo prioritetą, \texttt{enable} bitus ir konteksto \texttt{threshold} reikšmę. Jei sąlygos tenkinamos, procesoriui pateikiama išorinė pertrauktis M arba S režimui.
