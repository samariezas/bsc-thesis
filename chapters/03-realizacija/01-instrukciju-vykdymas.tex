...
Realizacijoje palaikomos RV64 bazinės instrukcijos, RV64 specifinės \texttt{W} operacijos, \texttt{M} plėtinio daugyba ir dalyba, \texttt{A} plėtinio atominės operacijos, privilegijuotos instrukcijos ir QPU instrukcijos. FPU plėtinys nebuvo įgyvendintas, tačiau slenkančio kablelio operacijos emuliatoriuje gali būti įvykdomos \textit{soft float} ABI pagalba.
