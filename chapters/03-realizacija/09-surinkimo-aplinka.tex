...
DTB failas nėra laikomas statiniu artefaktu. Prieš paleidimą jis sugeneruojamas pagal faktinį initramfs failo dydį, kad \texttt{linux,initrd-end} reikšmė atitiktų naują archyvą. Šis sprendimas svarbus, nes Linux branduolys initramfs ribas gauna per DTB \texttt{chosen} mazgą.
