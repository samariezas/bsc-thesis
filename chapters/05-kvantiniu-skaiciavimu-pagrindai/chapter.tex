...
Groverio algoritmui suprasti būtini keli konceptai: kubitas, kelių kubitų būsenos vektorius, amplitudės ir jų tikimybės, unitarių vartų veikimas, matavimas, oracle funkcija ir amplitudžių stiprinimas. Šie konceptai yra standartinė kvantinių skaičiavimų įžanga \cite{nielsen_chuang_2010,mermin_2007}, tačiau šiame darbe jie pateikiami iš sistemos programuotojo perspektyvos: kaip operacijos, kurias turi būti įmanoma iškviesti iš RISC-V programos per QPU instrukcijas.

\input{chapters/05-kvantiniu-skaiciavimu-pagrindai/02-kubitai-ir-registrai}
\input{chapters/05-kvantiniu-skaiciavimu-pagrindai/03-kvantiniai-vartai}
\input{chapters/05-kvantiniu-skaiciavimu-pagrindai/04-matavimas-ir-tikimybes}
\input{chapters/05-kvantiniu-skaiciavimu-pagrindai/05-groverio-algoritmas}
