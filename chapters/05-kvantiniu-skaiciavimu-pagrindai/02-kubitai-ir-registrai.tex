...
Groverio algoritme registras naudojamas paieškos erdvei aprašyti. Jeigu ieškoma reikšmė telpa į $n$ bitų, paieškos erdvės dydis yra $N = 2^n$. Algoritmo tikslas -- padidinti ieškomos reikšmės amplitudę taip, kad matavimo metu ji būtų gauta su didele tikimybe \cite{grover_1996}.
